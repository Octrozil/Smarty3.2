 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Tag_Assign extends Smarty_Compiler_Template_Tag
{
    ...
    {
        // the following must be assigned at runtime because it will be overwritten in Smarty_Compiler_Template_Tag_Append
