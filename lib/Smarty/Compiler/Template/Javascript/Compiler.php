 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Compiler extends Smarty_Compiler
{
     ...
     * @param Smarty_Resource_Source $source
     ...
     * class name format:  Smarty_Compiler_Template_Javascript_Tag_TagName
     *
     * @param  string $tag    tag name
