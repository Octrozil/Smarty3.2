 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Function extends Smarty_Compiler_Template_Javascript_Tag
{
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Functionclose extends Smarty_Compiler_Template_Javascript_Tag
{
