 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Block extends Smarty_Compiler_Template_Javascript_Tag
{
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Blockclose extends Smarty_Compiler_Template_Javascript_Tag
{
    ...
    public function compile($args, $compiler)
    {
        ...
        if ($compiler->isInheritanceChild && $compiler->block_nesting_level == 1) {
            if ($compiler->tag_nocache) {
                ...
                $code->php("\$this->inheritance_blocks['$int_name']['valid'] = true;")->newline();
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Internal_Block_Parent extends Smarty_Compiler_Template_Javascript_Tag
{
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Internal_Block_Child extends Smarty_Compiler_Template_Javascript_Tag
{
