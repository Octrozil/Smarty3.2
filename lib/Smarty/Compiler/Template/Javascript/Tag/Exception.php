 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Exception extends Smarty_Compiler_Template_Javascript_Tag
{
    ...
    public function compile($args, $compiler)
    {
        ...
        $this->php("throw new Smarty_Exception_Runtime($message);")->newline();
