 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Capture extends Smarty_Compiler_Template_Javascript_Tag
{
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_CaptureClose extends Smarty_Compiler_Template_Javascript_Tag
{
    ...
    public function compile($args, $compiler)
    {
        ...
        list($buffer, $assign, $append, $compiler->nocache) = array_pop(Smarty_Compiler_Template_Javascript_Tag_Capture::$_capture_stack);
