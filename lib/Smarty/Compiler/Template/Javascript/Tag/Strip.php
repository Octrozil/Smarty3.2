 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Strip extends Smarty_Compiler_Template_Javascript_Tag
{
 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Javascript_Tag_Stripclose extends Smarty_Compiler_Template_Javascript_Tag
{
