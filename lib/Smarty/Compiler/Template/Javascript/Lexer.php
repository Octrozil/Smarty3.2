...
* Smarty Template Lexer
*/
class Smarty_Compiler_Template_Javascript_Lexer extends Smarty_Exception_Magic
{
    public $data = null;
    public $counter = null;
    public $token = null;
...
//        $this->data = preg_replace("/(\r\n|\r|\n)/", "\n", $data);
    ...
    function yy_r1_1($yy_subpatterns)
    {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_TEMPLATEINIT;
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_TEXT;
    }
    function yy_r2_2($yy_subpatterns)
    {

    $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_STRIPON;
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal) {
    ...
    $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_STRIPOFF;
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal) {
   ...
   $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LITERALSTART;
  ...
  if ($this->compiler->tpl_obj->auto_literal) {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDELSLASH;
  ...
  if ($this->compiler->tpl_obj->auto_literal && trim(substr($this->value,$this->ldel_length,1)) == '') {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDELIF;
     $this->yypushstate(self::SMARTY);
     $this->taglineno = $this->line + $this->line_offset;
  }
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal && trim(substr($this->value,$this->ldel_length,1)) == '') {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDELFOR;
     $this->yypushstate(self::SMARTY);
     $this->taglineno = $this->line + $this->line_offset;
  }
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal && trim(substr($this->value,$this->ldel_length,1)) == '') {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDELFOREACH;
     $this->yypushstate(self::SMARTY);
     $this->taglineno = $this->line + $this->line_offset;
  }
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal && trim(substr($this->value,$this->ldel_length,1)) == '') {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDELSETFILTER;
     $this->yypushstate(self::SMARTY);
     $this->taglineno = $this->line + $this->line_offset;
  }
    }
  ...
  if ($this->compiler->tpl_obj->auto_literal) {
     ...
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LDEL;
     $this->yypushstate(self::SMARTY);
     $this->taglineno = $this->line + $this->line_offset;
  }
    }
  ...
  if (in_array($this->value, Array('<?', '<?=', '<?php'))) {
    $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_PHPSTARTTAG;
  } elseif ($this->value == '<?xml') {
      $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_XMLTAG;
  } else {
    $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_FAKEPHPSTARTTAG;
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_PHPENDTAG;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ASPSTARTTAG;
    }
    function yy_r2_29($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ASPENDTAG;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_SINGLEQUOTESTRING;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_RDEL;
  $this->yypopstate();
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_COMMENT;
    }
    function yy_r3_24($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISIN;
    }
    function yy_r3_25($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_AS;
    }
    function yy_r3_26($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_TO;
    }
    function yy_r3_27($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_STEP;
    }
    function yy_r3_28($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_INSTANCEOF;
    }
    function yy_r3_29($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_IDENTITY;
    }
    function yy_r3_30($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_NONEIDENTITY;
    }
    function yy_r3_31($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_EQUALS;
    }
    function yy_r3_32($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_NOTEQUALS;
    }
    function yy_r3_34($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_GREATEREQUAL;
    }
    function yy_r3_36($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LESSEQUAL;
    }
    function yy_r3_38($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_GREATERTHAN;
    }
    function yy_r3_39($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LESSTHAN;
    }
    function yy_r3_40($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_MOD;
    }
    function yy_r3_41($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_NOT;
    }
    function yy_r3_42($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LAND;
    }
    function yy_r3_43($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LOR;
    }
    function yy_r3_44($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LXOR;
    }
    function yy_r3_45($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISODDBY;
    }
    function yy_r3_46($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISNOTODDBY;
    }
    function yy_r3_47($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISODD;
    }
    function yy_r3_48($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISNOTODD;
    }
    function yy_r3_49($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISEVENBY;
    }
    function yy_r3_50($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISNOTEVENBY;
    }
    function yy_r3_51($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISEVEN;
    }
    function yy_r3_52($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISNOTEVEN;
    }
    function yy_r3_53($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISDIVBY;
    }
    function yy_r3_54($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ISNOTDIVBY;
    }
    function yy_r3_55($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_TYPECAST;
    }
    function yy_r3_59($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_OPENP;
    }
    function yy_r3_60($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_CLOSEP;
    }
    function yy_r3_61($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_OPENB;
    }
    function yy_r3_62($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_CLOSEB;
    }
    function yy_r3_63($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_PTR;
    }
    function yy_r3_64($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_APTR;
    }
    function yy_r3_65($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_EQUAL;
    }
    function yy_r3_66($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_UNIMATH;
    }
    function yy_r3_68($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_MATH;
    }
    function yy_r3_70($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_IDINCDEC;
    }
    function yy_r3_72($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_DOLLAR;
    }
    function yy_r3_73($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_SEMICOLON;
    }
    function yy_r3_74($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_DOUBLECOLON;
    }
    function yy_r3_75($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_COLON;
    }
    function yy_r3_76($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_AT;
    }
    function yy_r3_77($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_HATCH;
    }
    function yy_r3_78($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_QUOTE;
  $this->yypushstate(self::DOUBLEQUOTEDSTRING);
    }
    function yy_r3_79($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_BACKTICK;
  $this->yypopstate();
    }
    function yy_r3_80($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_VERT;
    }
    function yy_r3_81($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_DOT;
    }
    function yy_r3_82($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_COMMA;
    }
    function yy_r3_83($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ANDSYM;
    }
    function yy_r3_84($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_QMARK;
    }
    function yy_r3_85($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_HEX;
    }
  ...
  if (substr($this->data, $this->counter + strlen($this->value) - 1, $this->rdel_length) == $this->compiler->tpl_obj->right_delimiter) {
     ...
     $this->value = $match[0];
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_SPACE;
  } else {
     $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ATTR;
  }
    }
    function yy_r3_87($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_ID;
    }
    function yy_r3_88($yy_subpatterns)
    {

  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_INTEGER;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_NAMESPACE;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LITERALEND;
  $this->yypopstate();
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_LITERAL;
    }
  ...
  $this->token = Smarty_Compiler_Template_Javascript_Parser::TP_DOLLARID;
    }
