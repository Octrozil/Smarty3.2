 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Php_Tag_Internal_InheritanceTemplate extends Smarty_Compiler_Template_Php_Tag
{
    ...
    public function compile($args, $compiler, $parameter, $tag, $function)
    {
        ...
        if ($_attr['child'] === true) {
            ...
            $this->php("\$compiled_obj->_getRenderedTemplate\$this->smarty, \$_scope);")->newline();
        } else {
            ...
            $this->php("echo \$compiled_obj->_getRenderedTemplate(\$this->smarty, \$_scope);")->newline();
        }
