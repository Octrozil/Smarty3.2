 ...
 * @package Compiler
 */
class Smarty_Compiler_Template_Php_Tag_ConfigLoad extends Smarty_Compiler_Template_Php_Tag
{
    ...
    public function compile($args, $compiler)
    {
        ...
        $this->php("\$this->configLoad($conf_file, $section, {$scope_type});")->newline();
