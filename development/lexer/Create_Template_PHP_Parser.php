...
$lex = new PHP_LexerGenerator('Smarty_Compiler_Template_PHP_Lexer.plex');
$contents = file_get_contents('Smarty_Compiler_Template_PHP_Lexer.php');
$contents = str_replace(array('SMARTYldel','SMARTYrdel'),array('".$this->ldel."','".$this->rdel."'),$contents);
file_put_contents('Smarty_Compiler_Template_PHP_Lexer.php', substr($contents, 0 , strlen($contents)-2));
copy('Smarty_Compiler_Template_PHP_Lexer.php','../../lib/Smarty/Compiler/Template/PHP/Lexer.php');
