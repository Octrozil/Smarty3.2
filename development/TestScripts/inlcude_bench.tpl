...
//$smarty->display('child_exception.tpl');
//$smarty->display('test_block_ch.tpl');
//$smarty->display('extends:test_block_pa.tpl|test_block_ch.tpl');
//if (!$smarty->isCached('bug.tpl')) {
//    echo 'refresh';
//}
//$smarty->display('extends:bug_parent.tpl|bug_child.tpl');
$smarty->display('test_import.tpl');
//$smarty->display('bug.tpl');
//$smarty->display('template.tpl');
//$smarty->display("string: {include './include.tpl'}");

//$smarty->clearCache(null,'uwe');
