...
set PHPBIN="C:\wamp\bin\phpphp5.4.3\php.exe"
"C:\wamp\bin\php\php5.4.3\php.exe">_results_single.txt "C:\wamp\bin\php\php5.4.3\phpunit" --verbose _runSingleTest.php
