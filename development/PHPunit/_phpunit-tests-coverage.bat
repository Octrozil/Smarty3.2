...
"C:\wamp\bin\php\php5.4.3\.\php.exe">_results_cover.txt "C:\wamp\bin\php\php5.4.3\phpunit" --coverage-html coverage  --configuration _coverage.xml _runAllTests.php
